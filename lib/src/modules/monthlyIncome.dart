...
class MonthlyIncomeModule {
 final MonthlyIncomeModel _monthlyIncomeModel=MonthlyIncomeModel();
  ...
  //Future List
  Future<List<QueryDocumentSnapshot<Map<String, dynamic>>>> fetchIncomeFuture() async{
    return (await _monthlyIncomeModel.fetchAll());
  }
  //update Income

  Future<ResponseModel> updateIncome(String _id,Map<String,dynamic> monthlyIncomeModel) async{
